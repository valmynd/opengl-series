...
static void LoadWoodenCrateAsset() {
    ...
    gWoodenCrate.shaders = LoadShaders("source/05_asset_instance/resources/vertex-shader.glsl", "source/05_asset_instance/resources/fragment-shader.glsl");
    gWoodenCrate.drawType = GL_TRIANGLES;
    gWoodenCrate.drawStart = 0;
    gWoodenCrate.drawCount = 6*2*3;
    gWoodenCrate.texture = LoadTexture("source/05_asset_instance/resources/wooden-crate.jpg");
